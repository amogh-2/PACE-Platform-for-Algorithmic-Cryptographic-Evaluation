...
def save_benchmark_result(result, benchmark_folder):
    ...
    filename = f"chacha20_{result['file_size']}.txt"
...
def run_chacha20_benchmark(file_size, benchmark_folder="benchmark_results"):
    try:
